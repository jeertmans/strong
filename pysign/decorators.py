...
def check_correct_typing(func: Callable, join: bool = True, output: Callable = DEFAULT_OUTPUT):
    args_mapping, out_type = get_function_parameters(func)
    
    def wrap(*args, **kwargs):
        output_if_args_incorrect_typing(args_mapping, *args, join=join, output=output, **kwargs)
